                                    ...
                                    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
                                        <tr>
                                            <td class="button-td button-td-primary" style="border-radius: 4px; background: #222222;">
											     <a class="button-a button-a-primary" href="https://google.com/" style="background: #222222; border: 1px solid #000000; font-family: sans-serif; font-size: 15px; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #ffffff; display: block; border-radius: 4px;">Valider le compte</a>
											</td>
                                        </tr>
                                    </table>
                                     <br> 
                ...
                <tr>
                    <td style="background-color: #ffffff;">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    <h1 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 25px; line-height: 30px; color: #333333; font-weight: normal;">C'est une érreur ?</h1>
                                    <p style="margin: 0;">Si vous êtez pas à l'origine de la création du compte, merci de nous contacter par discord pour procéder à la destruction du compte en question. Vous recevrez un dernier mail une fois le compte supprimé.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
	        ...
	        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 0 auto;">
                <tr>
                    <td style="padding: 20px; font-family: sans-serif; font-size: 12px; line-height: 15px; text-align: center; color: #888888;">
                        <br><br>
						&copy; 2018 Cat's Eyes.<br><span class="unstyle-auto-detected-links">Site web par <a href="https://twitter.com/idrunk65">iDrunK</a> !</span>
                        <br><br>
                    </td>
                </tr>
            </table>
